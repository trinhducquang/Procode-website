          ...
          {isOpen && (
              ...
              >
                <motion.div
                    ...
                    className="fixed top-0 right-0 bottom-0 w-full max-w-sm bg-gray-900 dark:bg-gray-900 shadow-xl z-[10000] overflow-y-auto"
                  ...
                  <div className="relative z-10">
                      ...
                      {navItems.map((item) => {
                        ...
                        return (
                            <motion.div key={item.name} variants={itemVariants}>
                              <Link
                                  href={item.href}
                                  className={`block py-4 text-lg font-medium border-b border-gray-800 ${
                    ...
                    <motion.div variants={itemVariants} className="p-6 mt-4">
                      <div className="flex space-x-4 justify-center">
                        <a
                            href="#"
                            className="w-10 h-10 rounded-full flex items-center justify-center bg-gray-800 text-gray-400 hover:bg-gray-700 hover:text-white transition-colors"
                        >
